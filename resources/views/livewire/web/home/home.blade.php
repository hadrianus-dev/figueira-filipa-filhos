<div>
    ...
    <div class="page-content">
        ...
        <livewire:web.component.our-specialization>
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="about-home-right about-right-v2 bg-primary text-black p-a30">
                                    ...
                                    <p><strong>Contrary to popular belief, lorem Ipsum is not 
                                        ...
                                        <div class="text-left">
                                            <a href="#" class="site-button-secondry btn-effect">Saiba Mais</a>
                                        </div>                                                    
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="blog-post blog-grid date-style-2 bg-white">
                                    ...
                                    <div class="mt-post-info p-a30">
                                        ...
                                        <div class="mt-post-title ">
                                            <h4 class="post-title"><a href="javascript:void(0);">We’ll nail your next project, because nobody wants!</a></h4>
                                        </div>
                                        ...
                                        <div class="clearfix">
                                            <div class="mt-post-readmore pull-left">
                                                <a href="javascript:void(0);" title="READ MORE" rel="bookmark" class="site-button-link">Read More<i class="fa fa-angle-right arrow-animation"></i></a>
                                            </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="blog-post blog-grid date-style-2 bg-white">
                                    ...
                                    <div class="mt-post-media mt-img-effect zoom-slow">
                                        <a href="javascript:void(0);"><img src="assets/images/blog/blog-grid/pic1.jpg" alt=""></a>
                                    </div>
                                    
                                    <div class="mt-post-info p-a30">
                                        
                                        <div class="mt-post-title ">
                                            <h4 class="post-title"><a href="javascript:void(0);">Helping you and your house become better acquainted.</a></h4>
                                        </div>
                                        
                                        <div class="mt-post-meta ">
                                            <ul>
                                                <li class="post-date"> <i class="fa fa-calendar"></i><strong>16</strong> <span>Jan</span> </li>
                                                <li class="post-author"><i class="fa fa-user"></i><a href="javascript:void(0);">By <span>John</span></a> </li>
                                                <li class="post-comment"><i class="fa fa-comments"></i> <a href="javascript:void(0);">0 Comments</a> </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="blog-post blog-grid date-style-2 bg-white">
                                    ...
                                    <div class="mt-post-info p-a30">
                                        ...
                                        <div class="mt-post-title ">
                                            <h4 class="post-title"><a href="javascript:void(0);">Creating quality urban lifestyles, building stronger communities.</a></h4>
                                        </div>
                                        
                                        <div class="mt-post-meta ">
                                            <ul>
                                                <li class="post-date"> <i class="fa fa-calendar"></i><strong>14</strong> <span>Feb</span> </li>
                                                <li class="post-author"><i class="fa fa-user"></i><a href="javascript:void(0);">By <span>John</span></a> </li>
                                                <li class="post-comment"><i class="fa fa-comments"></i> <a href="javascript:void(0);">0 Comments</a> </li>
                                            </ul>
                                        </div>
                ...
                <div class="container">
                    ...
                    <div class="section-content">
                        <div class="call-us-section text-center text-white">
                            ...
                            <h2 class="call-us-number m-b15 m-b0">(+244)-999-999-999</h2>
                            <h4 class="call-us-address m-t0 m-b20">Luanda, Viana-Luanda Sul, Rua Direita da Clinica Dentária </h4>
                            <a href="#" class="site-button btn-effect">Contacte-nos</a>
                        </div>
                    </div>
