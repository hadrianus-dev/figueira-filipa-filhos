<div>
   ...
   <div class="page-content">
                            ...
                            <div class="mt-icon-box-wraper center m-b30">
                                <div class="half-block-content icon-count-2 p-a30 p-tb50">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="mt-tilte m-b25">Architecture Design</h4>
                    ...
                    <div class="half-blocks">
                        <div class="mt-icon-box-wraper center m-b30">
                            <div class="half-block-content icon-count-2 bg-gray p-a30 p-tb50">
                                ...
                                <div class="icon-content">
                                    <h4 class="mt-tilte m-b25">Building Construction</h4>
                                    <p>lorem Ipsum available, but the majority have suffered alterati on in some form, by ious by accident.</p>
                                    <a href="#" class="site-button-link" data-hover="Read More">Read More <i class="fa fa-angle-right arrow-animation"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-4 m-b0">
                        ...
                        <div class="mt-icon-box-wraper center m-b30">
                            <div class="half-block-content icon-count-2 bg-gray p-a30 p-tb50">
                                ...
                                <div class="icon-content">
                                    <h4 class="mt-tilte m-b25">Building Renovation</h4>
                                    <p>lorem Ipsum available, but the majority have suffered alterati on in some form, by ious by accident.</p>
                                    <a href="#" class="site-button-link" data-hover="Read More">Read More <i class="fa fa-angle-right arrow-animation"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="about-home-right about-right-v2 bg-primary text-black p-a30">
                                    ...
                                    <div class="text-left">
                                        <a href="#" class="site-button-secondry btn-effect">Read More</a>
                                    </div>                                                    
                                </div>
                            </div>
                        </div>
            ...
            <div class="container get-in-touch-form">
                ...
                <div class="row">
                    ...
                    <div class="get-in-touch-form-section">
                        <div class="get-in-touch-form-section-img"><img src="assets/images/s-pic-1.png" alt=""></div>
                        <div class="get-in-touch-info arrow-animation">
                            <div class="mt-icon-box-wraper  p-a20 left bg-white hover-shadow">
                                <div class="icon-md m-b20 scale-in-center">
                                    <span class="icon-cell text-secondry"><img src="assets/images/icon/icon-img-01.png" alt=""></span>
                                </div>
                                <div class="icon-content">
                                    <h4 class="mt-tilte m-b0">Great Experience for Building Constrction & Renovation</h4>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- OUR SERVICES START -->
    <div class="section-full p-t80 p-b50 bg-white mobile-page-padding" style="background-image:url(assets/images/background/ptn-1.png)">
        <div class="section-content">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 col-xs-100pc">
                            ...
                            <div class="mt-icon-box-wraper bdr-l-1 bdr-solid bdr-gray">
                                <div class="relative   p-a30 ">
                                    ...
                                    <div class="icon-md inline-icon m-b15 text-primary scale-in-center">
                                        <span class="icon-cell"><img src="assets/images/icon/idea.png" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 col-xs-100pc">
                            ...
                            <div class="mt-icon-box-wraper bdr-l-1 bdr-solid bdr-gray">
                                <div class="relative  p-a30 ">
                                    ...
                                    <div class="icon-md inline-icon m-b15 text-primary scale-in-center">
                                        <span class="icon-cell"><img src="assets/images/icon/dump-truck.png" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 col-xs-100pc">
                            ...
                            <div class="mt-icon-box-wraper bdr-l-1 bdr-solid bdr-gray">
                                <div class="relative  p-a30">
                                    ...
                                    <div class="icon-md inline-icon m-b15 text-primary scale-in-center">
                                        <span class="icon-cell"><img src="assets/images/icon/architecture.png" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 col-xs-100pc">
                            ...
                            <div class="mt-icon-box-wraper bdr-l-1 bdr-solid bdr-gray">
                                <div class="relative p-a30 ">
                                    ...
                                    <div class="icon-md inline-icon m-b15 text-primary scale-in-center">
                                        <span class="icon-cell"><img src="assets/images/icon/planning.png" alt=""></span>
                                    </div>
                                    <div class="icon-content">
        ...
        <div class="container">
                ...
                <div class="section-content">
                    <div class="call-us-section text-center text-white">
                        ...
                        <a href="#" class="site-button btn-effect">Contact Us</a>
                    </div>
                </div>
    ...
    <!-- OUR Team END -->
     ...
     <!-- Our PRICING PLAN -->
    <div class="section-full text-center bg-gray bg-no-repeat p-t80 p-b50 bg-top-right mobile-page-padding" style="background-image:url(assets/images/background/bg-4.png)">
        <div class="container">
                            ...
                            <div class="pricingtable-wrapper pricing-table-style-5 bg-white overflow-hide hover-shadow bdr-t-4 bdr-solid bdr-primary">
                                <div class="pricingtable-inner">
                                    ...
                                    <div class="pricingtable-footer">
                                        <a href="javascript:void(0);" class="site-button btn-effect">Purchase</a>
                                    </div>
    ...
    <div class="section-full p-t80 bg-dark square_shape2  square_shape1 bg-moving" style="background-image:url(assets/images/background/bg-6.png)">
        <div class="container">
            <div class="section-content">
