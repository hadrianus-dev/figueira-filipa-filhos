        ...
        <div class="page-content">
            ...
            <div class="section-full p-t80 p-b50 bg-parallax bg-cover"  data-stellar-background-ratio="0.5" style="background-image:url(assets/images/background/bg5.jpg);">
            	<div class="container">
                    <!-- TITLE START -->
					<div class="section-head">
						<div class="mt-separator-outer separator-center">
                    ...
                    <!-- GALLERY CONTENT START -->
                     <div class="portfolio-wrap mfp-gallery work-grid row clearfix">
                        ...
                        <div class="masonry-item cat-1  col-md-3 col-sm-6 m-b30">
                        	<div class="mt-box   image-hover-block">
                                <div class="mt-thum-bx">
                                    <img src="assets/images/services/service-projects/shooping-mall.jpg" alt="">
                                </div>
                        ...
                        <div class="masonry-item cat-2 col-md-3 col-sm-6 m-b30">
                        	<div class="mt-box   image-hover-block">
                                <div class="mt-thum-bx">
                                    <img src="assets/images/services/service-projects/hospital.jpg" alt="">
                                </div>
                                <div class="mt-info  p-t20 text-white">
                        ...
                        <div class="masonry-item cat-3 col-md-3 col-sm-6 m-b30">
                        	<div class="mt-box   image-hover-block">
                                <div class="mt-thum-bx">
                                    <img src="assets/images/services/service-projects/garden-house.jpg" alt="">
                                </div>
                                <div class="mt-info  p-t20 text-white">
                        ...
                        <div class="masonry-item cat-4 col-md-3 col-sm-6 m-b30">
                        	<div class="mt-box   image-hover-block">
                                <div class="mt-thum-bx">
                                    <img src="assets/images/services/service-projects/villa.jpg" alt="">
                                </div>
                                <div class="mt-info  p-t20 text-white">
                        ...
                        <div class="masonry-item cat-5 col-md-3 col-sm-6 m-b30">
                        	<div class="mt-box   image-hover-block">
                                <div class="mt-thum-bx">
                                    <img src="assets/images/services/service-projects/road-construction.jpg" alt="">
                                </div>
                                <div class="mt-info  p-t20 text-white">
                        ...
                        <div class="masonry-item cat-4 col-md-3 col-sm-6 m-b30">
                        	<div class="mt-box   image-hover-block">
                                <div class="mt-thum-bx">
                                    <img src="assets/images/services/service-projects/bridge.jpg" alt="">
                                </div>
                                <div class="mt-info  p-t20 text-white">
                        ...
                        <div class="masonry-item cat-3 col-md-3 col-sm-6 m-b30">
                        	<div class="mt-box   image-hover-block">
                                <div class="mt-thum-bx">
                                    <img src="assets/images/services/service-projects/building-ren.jpg" alt="">
                                </div>
                                <div class="mt-info  p-t20 text-white">
                        ...
                        <div class="masonry-item cat-2 col-md-3 col-sm-6 m-b30">
                        	<div class="mt-box   image-hover-block">
                                <div class="mt-thum-bx">
                                    <img src="assets/images/services/service-projects/dam-construction.jpg" alt="">
                                </div>
                                <div class="mt-info  p-t20 text-white">
                              ...
                              <!-- TITLE START -->
                                <div class="section-head">
                                    <div class="mt-separator-outer separator-left">
                                        <div class="mt-separator">
                                            <h2 class="text-uppercase sep-line-one "><span class="font-weight-300 text-primary">Algumas</span> FAQ</h2>
                                        </div>
                                    </div>
                                </div>                   
                                <!-- TITLE END -->                                                              
                                    ...
                                    <div class="mt-accordion acc-bg-gray" id="accordion5">
                                        <div class="panel mt-panel">
                                            ...
                                            <div id="collapseOne5" class="acod-body collapse in">
                                                <div class="acod-content p-tb15"><p> Motivate others and change 
                                                the way we feel about ourselves. This is why I find them so interesting and 
                                                crucial on our paths to success mauris accumsan eros eget libero posuere vulputate. 
                                                Etiam elit elit, elementum sed varius at, adipiscing vitae est.
                                                Sed nec felis pellentesque, lacinia dui sed, ultricies sapien. 
                                                Pellentesque orci consectetur vel posuere posuere, rutrum eu 
                                                ipsum. Cost is important.</p></div>
                                            </div>
                                        </div>
                                        <div class="panel mt-panel">
                                            <div class="acod-head">
