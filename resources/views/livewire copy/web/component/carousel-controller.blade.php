    ...
    <div id="welcome_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="goodnews-header">
        <div id="rev_slider_one" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.3.1">
            <ul>	
                ...
                data-thumb="{{asset('./public/assets/images/main-slider/slider2/slide1.jpg')}}"  
                data-rotate="0"  
                ...
                data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('./public/assets/images/main-slider/slider2/slide1.jpg')}}" alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina=""/>
                    <!-- LAYERS -->
                   ...
                   data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;s:inherit;e:inherit;","ease":"Power3.easeInOut"}]'
                    ...
                    Conecte-se a FFF, conecte-se a fonte de soluções eficases para suas necessidades
               ...
               <li data-index="rs-902" 
                ...
                data-easeout="default" 
                data-masterspeed="default"  
                data-thumb="{{asset('./public/assets/images/main-slider/slider2/slide2.jpg')}}"  
                data-rotate="0"  
                data-fstransition="fade" 
                data-fsmasterspeed="300" 
                data-fsslotamount="7" 
                ...
                data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('./public/assets/images/main-slider/slider2/slide2.jpg')}}" alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 [ for overlay ] -->
                    <div class="tp-caption tp-shape tp-shapewrapper " 
                ...
                data-easeout="default" 
                data-masterspeed="default"  
                data-thumb="{{asset('./public/assets/images/main-slider/slider2/slide3.jpg')}}"  
                data-rotate="0"  
                data-fstransition="fade" 
                data-fsmasterspeed="300" 
                data-fsslotamount="7" 
                ...
                data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('./public/assets/images/main-slider/slider2/slide3.jpg')}}" alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 [ for overlay ] -->
                    <div class="tp-caption tp-shape tp-shapewrapper " 
