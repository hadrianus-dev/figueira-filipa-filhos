            ...
            <div class="header-middle bg-white">
                <div class="container">
                    <div class="logo-header">
                        <a href="index.html">
                            <img src="{{asset('./public/assets/images/logoff.png')}}" width="216" height="37" alt="" />
                        </a>
                    </div>
            ...
            <div class="sticky-header main-bar-wraper">
                <div class="main-bar header-botton nav-bg-secondry">
                    <div class="container">
                        ...
                        <!-- Contact Nav -->                            
                        <div class="contact-slide-hide " style="background-image:url({{asset('./public/assets/images/background/bg-5.png')}})"> 
