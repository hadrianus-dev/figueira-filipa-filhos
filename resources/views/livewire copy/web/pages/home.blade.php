<div>
    ...
    <div class="page-content">
                                ...
                                <div class="mt-icon-box-wraper center m-b30">
                                    <div class="half-block-content icon-count-2 p-a30 p-tb50">
                                        ...
                                        <div class="mt-icon-box-lg radius bg-gray m-b20 scale-in-center">
                                            <span class="icon-cell"><img src="{{asset('./public/assets/images/icon/compass.png')}}" alt=""></span>
                                        </div>
                                    ...
                                    <div class="bg-cover  half-blocks-bg" style="background-image:url({{asset('./public/assets/images/services/1.jpg')}})"></div>
                                </div>
                            </div>
                        ...
                        <div class="half-blocks">
                            <div class="mt-icon-box-wraper center m-b30">
                                <div class="half-block-content icon-count-2 bg-gray p-a30 p-tb50">
                                    ...
                                    <div class="mt-icon-box-lg radius bg-gray m-b20 scale-in-center">
                                        <span class="icon-cell"><img src="{{asset('./public/assets/images/icon/crane-1.png')}}" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                ...
                                <div class="bg-cover  half-blocks-bg" style="background-image:url({{asset('./public/assets/images/services/3.jpg')}})"></div>
                            </div>                                                            
                        </div>
                        </div>
                        <div class="col-md-4 col-sm-4 m-b0">
                            ...
                            <div class="mt-icon-box-wraper center m-b30">
                                <div class="half-block-content icon-count-2 bg-gray p-a30 p-tb50">
                                    ...
                                    <div class="mt-icon-box-lg radius bg-gray m-b20 scale-in-center">
                                        <span class="icon-cell"><img src="{{asset('./public/assets/images/icon/renovation.png')}}" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                ...
                                <div class="bg-cover  half-blocks-bg" style="background-image:url({{asset('./public/assets/images/services/2.jpg')}})"></div>
                            </div>
                            </div>                              
                        </div>
        ...
        <!-- ABOUT COMPANY START -->
        <div class="section-full " style="background-image:url({{asset('./public/assets/images/background/bg-map.png')}})">
            <div class="services-half-section-top " >
                                ...
                                <div class="owl-carousel about-home about-home-v2 owl-dots-bottom-left">
                                    ...
                                    <div class="item ">
                                        <div class="mt-img-effect zoom-slow">
                                            <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/pic8.jpg')}}" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- COLUMNS 2 --> 
                                    <div class="item ">
                                        <div class="mt-img-effect zoom-slow">
                                            <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/pic6.jpg')}}" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- COLUMNS 3 --> 
                                    <div class="item ">
                                        <div class="mt-img-effect zoom-slow">
                                            <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/pic9.jpg')}}" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- COLUMNS 4 --> 
                                    <div class="item ">
                                        <div class="mt-img-effect zoom-slow">
                                            <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/pic2.jpg')}}" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- COLUMNS 5 --> 
                                    <div class="item ">
                                        <div class="mt-img-effect zoom-slow">
                                            <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/pic3.jpg')}}" alt=""></a>
                                        </div>
                                    </div>                                                                                                                                                                
                                </div>
                            </div>
                ...
                <div class="services-half-section-bottom p-t80 p-b50  bg-secondry bg-cover bg-center bg-no-repeat" style="background-image:url({{asset('./public/assets/images/background/bg5.jpg')}})">
                    <div class="container">
                        <div class="section-content">
                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-7 col-sm-6">
                                <div class="video-section-full-v2">
                                    <div class="video-section-full bg-no-repeat bg-cover overlay-wraper m-b30" style="background-image:url({{asset('./public/assets/images/video-bg2.jpg')}})">
            ...
            <!-- OUR BLOG START -->
            <div class="section-full mobile-page-padding p-t80 p-b30 square_shape1 bg-parallax bg-cover"  data-stellar-background-ratio="0.5" style="background-image:url({{asset('./public/assets/images/background/bg5.jpg')}});">
                <div class="container">
            ...
            <!-- OUR BLOG END -->
                        ...
                        <div class="section-full p-t80 p-b50 bg-dark" style="background-image:url({{asset('./public/assets/images/background/bg-5.png')}});">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="mt-icon-box-wraper p-a30 center m-b30 bg-white">
                                                <div class="mt-icon-box-sm inline-icon text-primary  m-b20 radius bg-primary  scale-in-center bg-moving" style="background-image:url({{asset('./public/assets/images/background/line.png')}})">
            ...
            <div class="section-full p-tb80 overlay-wraper bg-center bg-parallax bg-cover"  data-stellar-background-ratio="0.5" style="background-image:url({{asset('./public/assets/images/background/bg-10.jpg')}})">
            ...
            <!-- OUR Team START -->
            <div class="section-full p-t80 p-b50 square_shape1 bg-parallax bg-cover" data-stellar-background-ratio="0.5" style="background-image:url({{asset('./public/assets/images/background/bg5.jpg')}});">
                <div class="container">
