        ...
        <div class="page-content">
            ...
            <div class="section-full p-t80 p-b30 bg-dark" style="background-image:url(./public/assets/images/background/bg-6.png);">
				<div class="container">
            ...
            <div class="section-full p-t80 p-b50 bg-parallax bg-cover"  data-stellar-background-ratio="0.5" style="background-image:url({{asset('./public/assets/images/background/bg5.jpg')}});">
            	<div class="container">
                    <!-- TITLE START -->
