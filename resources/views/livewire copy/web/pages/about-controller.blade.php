        ...
        <div class="page-content">
                    	...
                    	<div class="row">
                        	<div class="col-md-5 col-sm-6">
                            	<div class="m-about ">
                            		<div class="owl-carousel about-us-carousel">
                                        ...
                                        <div class="item">
                                            <div class="ow-img">
                                                <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/portrait/pic4.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 2 -->
                                        <div class="item">
                                            <div class="ow-img">
                                                <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/portrait/pic5.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 3 -->
                                        <div class="item">
                                            <div class="owl-img">
                                                <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/portrait/pic6.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 4 -->
                                        <div class="item">
                                            <div class="ow-img">
                                                <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/portrait/pic7.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 5 -->
                                        <div class="item">
                                            <div class="ow-img">
                                                <a href="javascript:void(0);"><img src="{{asset('./public/assets/images/gallery/portrait/pic1.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                   </div>
                               </div>
                    		...
                    		<div class="col-md-7 col-sm-6">
                            	<div class="m-about-containt text-black p-t80">
                                	<div class="m-about-years bg-moving" style="background-image:url({{asset('./public/assets/images/background/line.png')}});">
                                    ...
                                    <div class="author-info p-t20">
                                        ...
                                        <div class="author-signature">
                                            <img src="{{asset('./public/assets/images/Signature+Black.png')}}" alt="Signature" width="150"/>
                                        </div>
            ...
            <div class="section-full p-tb80 bg-white bg-repeat square_shape2 inner-page-padding"  style="background-image:url({{asset('./public/assets/images/background/ptn-1.png')}})">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    ...
                                    <div class="mt-icon-box-wraper m-b30">
                                        <div class="relative icon-count-2 bg-gray p-a30 p-tb50">
                                            ...
                                            <div class="icon-md inline-icon m-b15 text-primary scale-in-center">
                                                <span class="icon-cell"><img src="{{asset('./public/assets/images/icon/toolbox.png')}}" alt=""></span>
                                            </div>
                                            <div class="icon-content">
